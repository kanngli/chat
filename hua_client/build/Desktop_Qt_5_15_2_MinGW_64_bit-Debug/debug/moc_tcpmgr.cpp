...
QT_MOC_LITERAL(8, 64, 16), // "slot_tcp_connect"
QT_MOC_LITERAL(9, 81, 10), // "ServerInfo"
QT_MOC_LITERAL(10, 92, 2), // "si"
QT_MOC_LITERAL(11, 95, 14) // "slot_send_data"

    },
    "TcpMgr\0sig_con_success\0\0bsuccess\0"
    "sig_send_data\0ReqId\0reqId\0data\0"
    "slot_tcp_connect\0ServerInfo\0si\0"
    "slot_send_data"
};
...
void TcpMgr::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->slot_tcp_connect((*reinterpret_cast< ServerInfo(*)>(_a[1]))); break;
        case 3: _t->slot_send_data((*reinterpret_cast< ReqId(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
...
void *TcpMgr::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "enable_shared_from_this<TcpMgr>"))
        return static_cast< enable_shared_from_this<TcpMgr>*>(this);
